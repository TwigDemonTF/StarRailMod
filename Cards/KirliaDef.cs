...
{
    public sealed class KirliaDef : CardTemplate
    {
        public override IdContainer GetId()
        {
            return nameof(Kirlia);
        }
        ...
        [EntityLogic(typeof(KirliaDef))]
        public sealed class Kirlia : Card {
            ...
            public override IEnumerable<BattleAction> GetPassiveActions() {
                ...
                yield return BuffAction<Firepower>(2);
                yield return BuffAction<Spirit>(2);
                if (base.Loyalty >= 5)
                    yield break;
